...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 23 22:35:30 2021
...
'''
fly_dir = '/NSLS2/xf18id1/users/2021Q1/KAREN_Proposal_307144/'
recon_dir = '/home/xf18id/Desktop/users/2021Q1/KAREN_Proposal_307144/92219_92227_stitch/'
...
#x_stage[9] = x_stage[3]
#x_stage[25] = x_stage[19]
#x_stage[30] = x_stage[36]
#x_stage[40]=x_stage[34]
#y_stage[30]=y_stage[31]
...
h_mosaicstep = int(h_motorstep*1000/pixel_size) # bin2 (mosaic step size is the center-to-center distance)
v_mosaicstep = int(v_motorstep*1000/pixel_size) # bin2 (750 for CB, 125 CNT )
...
fout  = recon_dir + f'stitch_motor_{scan_start}_{scan_end}.tiff' 
